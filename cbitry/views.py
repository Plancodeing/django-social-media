...
def post_detail(request,pk):
    ...
    return render(request,'cbitry/post_detail.html',context)
...
def favorite_list(request):
    ...
    return render(request,'cbitry/bookmark.html',context)
...
class PostListView(LoginRequiredMixin,ListView):
    model = Post
    template_name = 'cbitry/feed.html'
...
def feed(request):
    return render(request, 'cbitry/feed.html')
...
def delete_user(request):
    ...
    return render(request,'cbitry/deactivate.html',context)
...
def signup(request):
    ...
    return render(request,'cbitry/signup.html',{'form':form,'title':'Sign up to cbitry'})

@login_required
def filter_list(request):
    f = PostFilter(request.GET, queryset=Post.objects.all().order_by('-date_posted'))
    return render(request, 'cbitry/filtered.html', {'filter': f,'title':'Search Post in cbitry'})

def home(request):
    context = {
        'title':'cbitry Home'
    }
    return render(request,'cbitry/home.html',context)
...
def document(request):
    ...
    return render(request,'cbitry/fileupload.html',context)
...
def trending(request):
    ...
    return render(request,'cbitry/trending.html',context)
...
def dashboard(request):
    ...
    return render(request,'cbitry/dashboard.html',context)
...
def profile(request):
	...
	return render(request,'cbitry/profile.html',context)
